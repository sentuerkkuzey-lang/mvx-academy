...
// Hauptseite läuft auf einer anderen Domain (mvx-esports.com) -> absolute Links statt <Link>
const MAIN_SITE = "https://mvx-esports.com";
        ...
        <div className="container-xl pt-16 pb-32 md:pt-28 md:pb-40">
          <Reveal>
            <div className="flex justify-center">
              <MvxAcademyLogo className="h-32 w-32 md:h-44 md:w-44 rounded-full shadow-[0_30px_120px_-30px_rgba(255,255,255,0.25)]" />
            </div>
          </Reveal>
